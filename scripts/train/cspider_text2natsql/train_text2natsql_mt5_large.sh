...
# train text2natsql-mt5-large-cspider model
python -u text2sql.py \
    ...
    --epochs 128 \
    --seed 42 \
    --save_path "./models/text2natsql-mt5-large-cspider" \
    --tensorboard_save_path "./tensorboard_log/text2natsql-mt5-large-cspider" \
    --model_name_or_path "google/mt5-large" \
    --use_adafactor \
    --mode train \
    --train_filepath "./data/preprocessed_data/resdsql_train_cspider_natsql.json"

# select the best text2natsql-mt5-large-cspider ckpt
python -u evaluate_text2sql_ckpts.py \
    --batch_size 12 \
    --device "0" \
    --seed 42 \
    --save_path "./models/text2natsql-mt5-large-cspider" \
    --eval_results_path "./eval_results/text2natsql-mt5-large-cspider" \
    --mode eval \
